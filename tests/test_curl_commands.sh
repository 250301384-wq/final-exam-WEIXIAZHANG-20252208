...
curl -s "${BASE_URL}/api/v1/anomalies?sensor=temperature&limit=10" | python3 -m json.tool
...
curl -s -i "${BASE_URL}/api/v1/sensors/noise/latest"
curl -s -i "${BASE_URL}/api/v1/sensors/temperature/stats?days=0"
